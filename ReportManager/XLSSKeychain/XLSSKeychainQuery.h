...
@import Security;
	...
	#define XLSSKeychain_SYNCHRONIZATION_AVAILABLE 1
#endif

#ifdef XLSSKeychain_SYNCHRONIZATION_AVAILABLE
typedef NS_ENUM(NSUInteger, XLSSKeychainQuerySynchronizationMode) {
	XLSSKeychainQuerySynchronizationModeAny,
	XLSSKeychainQuerySynchronizationModeNo,
	XLSSKeychainQuerySynchronizationModeYes
};
#endif
 ...
 */
@interface XLSSKeychainQuery : NSObject
...
@property (nonatomic) XLSSKeychainQuerySynchronizationMode synchronizationMode;
#endif
...
/**
 ...
 XLSSKeychain_SYNCHRONIZATION_AVAILABLE is only for compile time. If you are checking for the presence of synchronization,
