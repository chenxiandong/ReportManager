...
/**
 Error code specific to XLXLSSKeychain that can be returned in NSError objects.
 For codes returned by the operating system, refer to SecBase.h for your
 platform.
 */
typedef NS_ENUM(OSStatus, XLXLSSKeychainErrorCode) {
	/** Some of the arguments were invalid. */
	XLSSKeychainErrorBadArguments = -1001,
};

/** XLSSKeychain error domain */
extern NSString *const kXLSSKeychainErrorDomain;

/** Account name. */
extern NSString *const kXLSSKeychainAccountKey;
 ...
 */
extern NSString *const kXLSSKeychainCreatedAtKey;

/** Item class. */
extern NSString *const kXLSSKeychainClassKey;

/** Item description. */
extern NSString *const kXLSSKeychainDescriptionKey;

/** Item label. */
extern NSString *const kXLSSKeychainLabelKey;

/** Time the item was last modified.

 The value will be a string.
 */
extern NSString *const kXLSSKeychainLastModifiedKey;

/** Where the item was created. */
extern NSString *const kXLSSKeychainWhereKey;
...
/**
 ...
 XLSSKeychain has since switched to a simpler implementation that was abstracted from [SSToolkit](http://sstoolk.it).
 */
@interface XLSSKeychain : NSObject
...
/**
 ...
 See the `NSString` constants declared in XLSSKeychain.h for a list of keys that can be used when accessing the
